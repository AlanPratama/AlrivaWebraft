...
@section('content')
    ...
    <form class="w-full" action="{{ route('serviceEdit', ['slug' => $service->slug]) }}" method="post">
        @csrf
        @method('PUT')
        @if ($errors->any())
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <select id="type" name="type_id"
                    ...
                    <option value="{{ $service->type->id }}" selected>{{ $service->type->name }}</option>
            ...
            <div>
                ...
                <input type="number" id="estimation" name="estimation" value="{{ $service->estimation }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
                <div class="mb-4">
                    <label for="price_before" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PRICE
                        BEFORE</label>
                    <input type="text" id="price_before" name="price_before" value="{{ $service->price_before }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="mb-4">
                    <label for="price_after" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PRICE
                        AFTER</label>
                    <input type="text" id="price_after" name="price_after" value="{{ $service->price_after }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
