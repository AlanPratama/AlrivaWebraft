                            ...
                            <div class="flex items-center gap-2">
                                @if (Auth::user()->role == 'Admin')
                                    <button type="button"
                                        ...
                                        onclick="openModalProses()">Diperiksa</button>
                                    ...
                                    <div class="main-modal-proses fixed w-full p-8 h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
                                        ...
                                        <div
                                            ...
                                            <div class="modal-content py-4 text-left px-6">
                                                ...
                                                <!--Body-->
                                                <div class="my-5">
                                                    <form action="{{ route('transactionToPeriksa', ['code' => $transaction->code]) }}" method="post" class="flex flex-col flex-wrap justify-start items-start gap-4">
                                                        @csrf
