    ...
    <div class="" style="margin-top: 130px;">
        <div class="w-full  my-4 border-b-2 pb-4">
            <div class="flex pb-3">
                ...
                <div class="flex-1">
                    <div
                        class="w-10 h-10 bg-green-500 text-white mx-auto rounded-full text-lg text-white flex items-center">
                        <span class="text-white text-center w-full"><ion-icon name="checkmark-done-outline" class="w-full"
                                style="font-size: 16px;"></ion-icon></span>
                    </div>
                </div>
        ...
        <div class="container px-5 mx-auto" style="padding: 40px 0px">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <p style="font-size: 18px;"><span class="inline font-semibold">Estimasi:</span>
                        {{ \Carbon\Carbon::parse($transaction->estimation)->format('d F Y') }}</p>
