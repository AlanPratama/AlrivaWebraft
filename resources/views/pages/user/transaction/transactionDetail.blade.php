...
@section('content')
    <section class="text-gray-700 body-font overflow-hidden bg-white"
        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <form action="{{ route('transaction.start', ['slug' => $service->slug]) }}" method="post"
                        class="border-t-2 border-b-2 pb-4 border-gray-200 pt-2 mt-5 flex flex-col justify-center items-start">
                        @csrf
                        <div class="w-full my-4">
                            <label for="message" style="font-size: 17px;"
                                class="block font-medium leading-6 text-gray-900">Pesan / Message</label>
                            <div class="relative mt-2 rounded-md shadow-sm">
                                <input type="text" name="message" id="message" style="font-size: 17px;"
                                    ...
                                    placeholder="Website nya yang keren ya...">
                            </div>
                        </div>
        ...
        <div class="w-full flex justify-center items-center pb-12">
            <!-- HOW TO BUY -->
