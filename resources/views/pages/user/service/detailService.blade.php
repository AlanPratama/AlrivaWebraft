        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="text-gray-600 ml-3">4 Terjual</span>
            </span>
          ...
          <p class="leading-relaxed" style="font-size: 20px;">Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric..</p>
          <div class="detail-text flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
            <span class="badge shadow">Statis</span>
            <span class="">|</span>
            <span class="badge shadow">eCommerce UMKM</span>
          </div>
          <div class="flex">
            <span class="title-font font-semibold text-2xl text-gray-900" style="font-size: 22px; font-weight: bold; opacity: 0.92;">RP 1,500K</span>
