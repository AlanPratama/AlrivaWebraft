...
<main>
    <article>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-text" style="text-transform: capitalize;">
              Membutuhkan Website dengan tampilan keren dengan harga yang murah? alriva webcraft tentu solusinya!
            </p>
          ...
          <figure class="hero-banner">
            ...
            <img src="./assets/images/hero-abs3.png" width="160" height="160" loading="lazy" aria-hidden="true"
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <figure class="about-banner">
            ...
            <img src="./assets/images/about-banner.png" width="450" height="590" loading="lazy" alt="about banner"
              class="w-100 about-img">

            <img src="./assets/images/about-abs-1.png" width="188" height="242" loading="lazy" aria-hidden="true"
              class="abs-img abs-img-1">
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                    Ini memastikan bahwa pengunjung dapat mengakses informasi dengan mudah, di device apapun.
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                    memastikan setiap fitur berjalan dengan baik untuk memberikan pengalaman pengguna yang memuaskan.
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                    Kami mengimplementasikan langkah-langkah keamanan yang canggih untuk melindungi data Anda, agar anda merasa aman.
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div>
                  ...
                  <p class="item-text">
                    Setiap bisnis pasti terdapat keunikan tersendiri, maka website dari kami dapat disesuaikan dengan
       ...
       <div class="min-h-screen items-center" id="harga">
        <div class="" style="padding: 0px 15px;">
            ...
            <div class="my-16 sm:flex flex-wrap justify-center items-center gap-8">
                <!-- Basic -->
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6 shadow-lg rounded-lg" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                    <div class="px-6 py-8 sm:p-10 sm:pb-6">
                        <div class="flex justify-center">
                            <span style="font-size: 22px;" class="inline-flex px-4 py-1 rounded-full leading-5 font-semibold tracking-wide uppercase">
                                Basic
                            </span>
                        </div>
                    ...
                    <ul class="text-2xl w-full mt-6 mb-6">
                        <li class="mb-3 flex items-center ">
                            <svg class="h-10 w-10 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6" stroke="currentColor" fill="green" viewBox="0 0 1792 1792">
                        ...
                        <li class="mb-3 flex items-center opacity-50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" class="h-10 w-10 mr-2" fill="red" viewBox="0 0 1792 1792">
                    ...
                    <button type="button" style="font-size: 20px;" class="w-full px-3 py-3 shadow rounded-lg text-indigo-500 hover:text-white bg-white hover:bg-indigo-500 transition-colors duration-700 transform">
                        Beli Sekarang
                    </button>
                </div>
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-indigo-500 text-white mt-6 rounded-lg" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                    <div class="px-6 py-8 sm:p-10 sm:pb-6">
                        <div class="flex justify-center">
                            <span style="font-size: 22px;" class="inline-flex px-4 py-1 rounded-full leading-5 font-semibold tracking-wide uppercase">
                                Popular
                    ...
                    <ul class="text-2xl w-full mt-6 mb-6">
                        <li class="mb-3 flex items-center ">
                            <svg class="h-10 w-10 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6" stroke="currentColor" fill="currentColor" viewBox="0 0 1792 1792">
                                <path d="M1412 734q0-28-18-46l-91-90q-19-19-45-19t-45 19l-408 407-226-226q-19-19-45-19t-45 19l-91 90q-18 18-18 46 0 27 18 45l362 362q19 19 45 19 27 0 46-19l543-543q18-18 18-45zm252 162q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z">
                                </path>
                            </svg>
                            All illimited components
                        ...
                        <li class="mb-3 flex items-center opacity-50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" class="h-10 w-10 mr-2" fill="currentColor" viewBox="0 0 1792 1792">
                                <path d="M1277 1122q0-26-19-45l-181-181 181-181q19-19 19-45 0-27-19-46l-90-90q-19-19-46-19-26 0-45 19l-181 181-181-181q-19-19-45-19-27 0-46 19l-90 90q-19 19-19 46 0 26 19 45l181 181-181 181q-19 19-19 45 0 27 19 46l90 90q19 19 46 19 26 0 45-19l181-181 181 181q19 19 45 19 27 0 46-19l90-90q19-19 19-46zm387-226q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z">
                                </path>
                            </svg>
                            Prenium svg
                    ...
                    <button type="button" style="font-size: 20px;" class="w-full px-3 py-3 shadow rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-700 transform">
                        Beli Sekarang
                    </button>
                </div>
      ...
      <section class="instructor">
        <div class="container">
          ...
          <div class="title-wrapper">
            <h2 class="h2 instructor-title"><span style="color: #525DE0; display: inline;">ALRIVA WEBCRAFT'S</span> DEVELOPERS</h2>
      ...
      <section class="section cta" aria-label="workshop" style="background-image: url('./assets/images/cta-bg.png')" id="contact">
        <div class="container">

          <figure class="cta-banner">
            <img src="./assets/images/person-front-computer-working-html.jpg" width="580" height="380" loading="lazy" alt="cta banner"
              class="img-cover">
          </figure>
