      ...
      <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
        <div class="max-w-md w-full space-y-8">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-500">Login dengan akun kamu</p>
          </div>
          ...
          <form class="mt-8 space-y-6" action="{{ route('loginProcess') }}" method="POST">
            ...
            <div class="relative">
              ...
              <input name="username"
                ...
                type="text" placeholder="Masukkan Username Kamu" value="{{ old('username') }}">
            </div>
            ...
            <p class="flex flex-wrap gap-2 items-center justify-center mt-10 text-center text-md text-gray-500">
