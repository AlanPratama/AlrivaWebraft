...
<head>
    ...
    <meta name="description"
        content="Jasa Pembuatan Website Terjangkau! Alriva WebCraft, Pembuat Website Profesional Dengan Harga Terjangkau!" />
    ...
    <header class="header" data-header>
        <div class="container">
            ...
            <h1 style="display: flex; justify-content: start; align-items: center; gap: 1;">
                ...
                <a href="{{ url('https://www.instagram.com/alrivawebcraft') }}" class="logo">ALRIVA <span
                        class="md:inline hidden">WEBCRAFT</span></a>
            </h1>
            ...
            <div class="header-actions">
                ...
                @if (Auth::user())
                    <button onclick="openModal()" class='header-action-btn'><ion-icon
                            name="person-circle-outline"></ion-icon></button>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-top">
                ...
                <div class="footer-brand">
                    ...
                    <p class="section-text">
                        Membutuhkan Website Dengan Tampilan
                        Keren Dengan Harga Yang Murah? Alriva Webcraft Tentu Solusinya!
                    </p>

                    <ul class="social-list">

                        <li>
                            <a href="https://wa.wizard.id/452953" class="social-link">
                                <ion-icon name="logo-whatsapp"></ion-icon>
                            </a>
                        </li>

                        <li>
                            <a href="https://www.instagram.com/alrivawebcraft" class="social-link">
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        <a href="#kategori" class="footer-link">
                            <ion-icon name="chevron-forward" aria-hidden="true"></ion-icon>
                    ...
                    <li>
                        <a href="#harga" class="footer-link">
                            <ion-icon name="chevron-forward" aria-hidden="true"></ion-icon>

                            <span class="span">Harga</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#portofolio" class="footer-link">
                            <ion-icon name="chevron-forward" aria-hidden="true"></ion-icon>

                            <span class="span">Portofolio</span>
                        </a>
                    </li>
            ...
            <div class="footer-bottom">
                <p class="copyright">
                    Copyright 2024 Alriva WebCraft. All Rights Reserved by <a
                        href="https://www.instagram.com/alrivawebcraft" class="copyright-link">Alriva WebCraft</a>
                </p>
            </div>
                ...
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="my-5">
                        <div class="flex flex-wrap justify-between items-center gap-4">
                            <a href="{{ url('/akun') }}" style="width: 48%; font-size: 20px; color: #535ce0e9;"
                                class="shadow py-12 flex flex-col justify-center items-center hover:bg-gray-100">
                                <ion-icon name="person-outline"></ion-icon>
                                <p>Akun</p>
                            </a>

                            <a href="{{ url('/transaksi') }}" style="width: 48%; font-size: 20px; color: #535ce0e9;"
                                class="shadow py-12 flex flex-col justify-center items-center hover:bg-gray-100">
